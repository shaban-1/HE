...
class DecomNet(nn.Module, ABC):
    def __init__(self, params):
        ...
        self.conv5 = nn.ConvTranspose2d(128, 64, 3, 2, 1, output_padding=1)
    ...
    def forward(self, input_im):
        ...
        # print('x4:', x4.shape)
        x5 = self.conv5(x4)
        x5 = torch.nn.functional.interpolate(x5, size=(x2.shape[2], x2.shape[3]), mode="bilinear", align_corners=True)
